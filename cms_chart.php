...
function cms_chart_css($css, $style) {
    ...
    echo '<style>';
    if ($css) echo '
svg.chart{display:block; margin-left: -15px;}
.chart-bg{fill:#fff;opacity:.5}
.chart-box{fill:#fff;opacity:1}
.chart-tick line{display:none;stroke:#ddd;stroke-width:1;stroke-dasharray:5,5}
.chart text{display:none;font-family:Helvetica,Arial,Verdana,sans-serif;font-size:12px;fill:#666}
